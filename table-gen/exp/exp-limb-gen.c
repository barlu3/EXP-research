/* Generate the bf16 limb tables for cr_exp_bf16_limb.
   ...
   Companion to log/limb-gen.c (which does the same job for ln), but the problem
   ...
   Usage: exp-limb-gen [OUT_FILE]   (default implementations/exp/expbf16-limb.h)
...
int main (int argc, char **argv) {
  const char *out_file = (argc > 1) ? argv[1]
                                    : "implementations/exp/expbf16-limb.h";
  ...
  fprintf (o,
    "/* Generated by table-gen/exp/exp-limb-gen.c -- do not edit by hand.\n"
    "\n"
