/* Generate the bf16 limb tables for cr_sin_bf16_limb.
   ...
   Third member of the family after log/limb-gen.c (ln) and exp/exp-limb-gen.c
   (exp).
   ...
   70 inputs; see sweep/limb-config-sweep.c for the measurement.
...
int main (int argc, char **argv) {
  ...
  fprintf (o,
    "/* Generated by table-gen/sin/sin-limb-gen.c -- do not edit by hand.\n"
    "\n"
